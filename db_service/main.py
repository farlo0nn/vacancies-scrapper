...
from _celery.tasks import handle_vacancies, handle_criterion_request, handle_upsert_user_data, handle_is_user_consuming_request, handle_get_user_data
        ...
        async for message in consumer:
            ...
            match message.topic:
                ...
                case "get_criterion":
                    ...
                    handle_criterion_request.delay(criterion_request)
                case "user_data":
